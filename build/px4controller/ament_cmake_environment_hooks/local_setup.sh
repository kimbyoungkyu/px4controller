...
: ${AMENT_CURRENT_PREFIX:="/root/px4controller/src/px4controller/install/px4controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4controller/environment/path.sh"
